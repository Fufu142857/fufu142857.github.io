...
<div id="world-container">
  ...
  <div id="portal-section">
    ...
    <div class="portal cv-side">
      <div class="portal-content">
        <h1>CV/CG</h1>
        <p>cd ./Visual_Computing</p>
      </div>
      <a href="{{ "/visual_computing" | relative_url }}" id="link-cv"></a>
    </div>
...
╚═╝      ╚═════╝ ╚═╝      ╚═════╝ v1.4.2.8.5.7` 
    ...
    { type: 'info', tag: 'Major', text: "CS / CV / CG" },
    ...
    { type: 'vol', tag: 'VOL_2', text: "CV/CG_Research", style: 'highlight' },
    { type: 'txt', text: ">> 我有志向进行深入研究，在此记录我的自学笔记，并整理我对大领域的整体思路框架。" },
